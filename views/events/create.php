    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">
                Evenimente<br/>
                <small>Completează formularul de mai jos pentru a crea un eveniment nou</small>
            </h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8">
            <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group<?=$errors['image'] ? ' has-error has-feedback' : ''?>">
                    <label class="control-label col-md-3" for="image">Imagine:</label>
                    <div class="col-md-9">
                        <input type="file" id="image" name="image">
                        <span class="help-block">Dimensiune: 800x500px. <?=$errors['image']?></span>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-offset-3 col-md-9">
                        <button type="submit" name="submit" class="btn btn-primary">Adaugă eveniment</button>
                    </div>
                </div>
            </form>
        </div>
